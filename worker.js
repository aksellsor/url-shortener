...
async function handleRequest(request) {
  ...
  if(!path){
    ...
    const html= await fetch("https://aksellsor.github.io/url-shortener/index.html")
  ...
  if (location) {
    if (config.safe_browsing_api_key){
      if(!(await is_url_safe(location))){
        let warning_page = await fetch("https://aksellsor.github.io/url-shortener/safe-browsing.html")
    ...
    if (config.no_ref=="on"){
      let no_ref= await fetch("https://aksellsor.github.io/url-shortener/no-ref.html")
